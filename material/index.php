	...
	<div id="current-theme" class="wp-filter plugin-categories">
		...
		<div class="theme-options plugin-options">
			...
			<div class="search-form">
				...
				<input aria-label="Search for plugins" type="search" id="theme-search-input" class="plugin-search-input" name="s" placeholder="<?php _e('Start typing to search', 'wmd_prettyplugins'); ?>" value="">
			</div>
					...
					<div class="material-plugin-wrapper">
						...
						<div class="material-button-wrapper action-links">
							...
							<?php if(isset($plugin['PluginLink'])) { ?>
								<a class="material-button button button-large" aria-label="Learn more button" style="color: #000;" href="<?php echo $plugin['PluginLink']; ?>" target="_blank" title="<?php _e('Learn more about the plugin', 'wmd_prettyplugins') ?>"><?php echo stripslashes($this->options['plugins_link_label']); ?></a>
							<?php } ?>
